...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Resumen Horario Centro
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
					<!-- BEGIN PAGE CONTENT-->
					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> NIVEL </th>
                                                <?php
													$busca_origenes="SELECT * FROM ORIGENES_HORAS WHERE ACTIVO=1 AND ABREVIATURA!='PR'";
						...
						while ($fila_niveles=mysql_fetch_row($result_niveles)){
							...
							while ($fila_cursos=mysql_fetch_row($result_cursos)){
								$busca_grupos="SELECT GRUPOS FROM UNIDADES_CONCERTADAS WHERE CURSO=$fila_cursos[0] AND (CENTRO!='FLAC01' AND CENTRO!='FLAC02' AND CENTRO!='29004225' AND CENTRO!='29004705') AND PGE=$pge";
							...
							while ($fila_origenes=mysql_fetch_row($result_origenes)){
								...
								$result_cursos=mysql_query($busca_cursos,$conexion);
									while ($fila_cursos=mysql_fetch_row($result_cursos)){
										$busca_grupos="SELECT GRUPOS FROM UNIDADES_CONCERTADAS WHERE PGE=$pge AND (CENTRO!='FLAC01' AND CENTRO!='FLAC02' AND CENTRO!='29004225' AND CENTRO!='29004705') AND CURSO=$fila_cursos[0]";
										//echo $busca_grupos;
										$result_grupos=mysql_query($busca_grupos,$conexion);
										while ($fila_grupos=mysql_fetch_row($result_grupos)){
										...
										$busca_horas_consumidas="SELECT HORAS_CONSUMIDAS FROM HORARIO WHERE PGE=$pge AND (CENTRO!='FLAC01' AND CENTRO!='FLAC02' AND CENTRO!='29004225' AND CENTRO!='29004705') AND NIVEL_EDUCATIVO=$fila_niveles[0] AND ORIGEN=$fila_origenes[0]";								
									...
									//Busco si tiene horas cargadas desde DC, al margen de las de concierto
										...
										$busca_carga="SELECT HORAS FROM CARGA_HORARIA WHERE PGE=$pge AND (CENTRO!='FLAC01' AND CENTRO!='FLAC02' AND CENTRO!='29004225' AND CENTRO!='29004705') AND NIVEL_EDUCATIVO=$fila_niveles[0] AND ORIGEN=$fila_origenes[0]";
							...
							echo "<td><strong>0/75</strong></td><td><strong>0/350</strong></td>";
